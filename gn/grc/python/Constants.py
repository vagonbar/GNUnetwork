...
#      ('TimerEvent', 'TimerEvent', '123', '#55cc66'),
      ...
      ('Ev Type; Mgmt', 'Mgmt', '140', '#33cc66'),
      ('Ev Type: Request', 'Request', '150', '#cc00cc'),
#      ('Nick: CtrlRTS', 'CtrlRTS', '121', '#448C69'),
#      ('Nick: :CtrlCTS', 'CtrlCTS', '122', '#338C69'),
#      ('Nick: CtrlACK', 'CtrlACK', '123', '#228C69'),
#      ('Nick: DataData', 'DataData', '124', '#228C69'),
#      ('Nick: TimerConfig', 'TimerConfig', '151', '#228C69'),
)
